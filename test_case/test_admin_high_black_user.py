...
class TestBlackUserAjaxAdminHighToUser(BaseCase):
    """
    黑名单(高管对普通用户)
    """
    ...
    def setUp(self, user_id=None, anchor_id=None):
        super(TestBlackUserAjaxAdminHighToUser,self).setUp()
    ...
    def tearDown(self, user_id=None, anchor_id=None):
        super(TestBlackUserAjaxAdminHighToUser,self).tearDown()
        for x in ['forbid_speak','forbid_shout','forbid_visit']:
            del_black_user_ajax = DelBlackUserAjax(self.admin_user_mobile)
            del_black_user_ajax.get({'room_id': self.room_id, 'anchor_id': self.anchor_id, 'user_id': self.user_id,'blacker_type': x})
        del_supervisor_ajax = DelSupervisorAjax(self.anchor_mobile)
...
class TestBlackUserAjaxAdminHighToAnchor(BaseCase):
    """
    黑名单(高管对主播)
    """
    admin_user_mobile = settings.TEST_USER_MOBILE
    ...
    def setUp(self, user_id=None, anchor_id=None):
        super(TestBlackUserAjaxAdminHighToAnchor,self).setUp()
        del_supervisor_ajax = DelSupervisorAjax(self.anchor_mobile)
        del_supervisor_ajax.get({'room_id': self.room_id, 'anchor_id': self.anchor_id, 'user_id': self.admin_user_id})
    ...
    def tearDown(self, user_id=None, anchor_id=None):
        super(TestBlackUserAjaxAdminHighToAnchor,self).tearDown()
        del_supervisor_ajax = DelSupervisorAjax(self.anchor_mobile)
        del_supervisor_ajax.get({'room_id': self.room_id, 'anchor_id': self.anchor_id, 'user_id': self.admin_user_id})
...
class TestBlackUserAjaxAdminHighToAdmin(BaseCase):
    """
    黑名单(高管对普管)
    """
    admin_user_mobile = settings.TEST_USER_MOBILE
    ...
    def setUp(self, user_id=None, anchor_id=None):
        super(TestBlackUserAjaxAdminHighToAdmin,self).setUp()
        for x in ['forbid_speak','forbid_shout','forbid_visit']:
            del_black_user_ajax = DelBlackUserAjax(self.admin_user_mobile)
            del_black_user_ajax.get({'room_id': self.room_id, 'anchor_id': self.anchor_id, 'user_id': self.user_id,'blacker_type': x})
    ...
    def tearDown(self, user_id=None, anchor_id=None):
        super(TestBlackUserAjaxAdminHighToAdmin,self).tearDown()
        for x in ['forbid_speak','forbid_shout','forbid_visit']:
            del_black_user_ajax = DelBlackUserAjax(self.admin_user_mobile)
            del_black_user_ajax.get({'room_id': self.room_id, 'anchor_id': self.anchor_id, 'user_id': self.user_id,'blacker_type': x})
        for x in [self.admin_user_id,self.user_id]:
...
class TestBlackUserAjaxAdminHighToOtherAnchor(BaseCase):
    """
    黑名单(高管对其他主播)
    """
    admin_user_mobile = settings.TEST_USER_MOBILE
    ...
    def setUp(self, user_id=None, anchor_id=None):
        super(TestBlackUserAjaxAdminHighToOtherAnchor,self).setUp()
        for x in ['forbid_speak','forbid_shout','forbid_visit']:
            del_black_user_ajax = DelBlackUserAjax(self.admin_user_mobile)
    ...
    def tearDown(self, user_id=None, anchor_id=None):
        super(TestBlackUserAjaxAdminHighToOtherAnchor,self).tearDown()
        for x in ['forbid_speak','forbid_shout','forbid_visit']:
            del_black_user_ajax = DelBlackUserAjax(self.admin_user_mobile)
            del_black_user_ajax.get({'room_id': self.room_id, 'anchor_id': self.anchor_id, 'user_id': self.other_anchor_id,'blacker_type': x})
        del_supervisor_ajax = DelSupervisorAjax(self.anchor_mobile)
...
class TestBlackUserAjaxAdminHighToGuard(BaseCase):
    """
    黑名单(高管对守护用户)
    """
    admin_user_mobile = settings.TEST_USER_MOBILE
    ...
    def setUp(self, user_id=None, anchor_id=None):
        super(TestBlackUserAjaxAdminHighToGuard,self).setUp(user_id=self.user_id,anchor_id=self.anchor_id)
        for x in ['forbid_speak','forbid_shout','forbid_visit']:
    ...
    def tearDown(self, user_id=None, anchor_id=None):
        super(TestBlackUserAjaxAdminHighToGuard,self).tearDown(user_id=self.user_id,anchor_id=self.anchor_id)
        for x in ['forbid_speak','forbid_shout','forbid_visit']:
            del_black_user_ajax = DelBlackUserAjax(self.anchor_mobile)
            del_black_user_ajax.get({'room_id': self.room_id, 'anchor_id': self.anchor_id, 'user_id': self.user_id,'blacker_type': x})
        del_supervisor_ajax = DelSupervisorAjax(self.anchor_mobile)
...
class TestBlackUserAjaxHighAdmiToNoble(BaseCase):
    """
    黑名单(高管对贵族用户)
    """
    admin_user_mobile = settings.TEST_USER_MOBILE
    ...
    def setUp(self, user_id=None, anchor_id=None):
        super(TestBlackUserAjaxHighAdmiToNoble,self).setUp(user_id=self.user_id)
        for x in ['forbid_speak','forbid_shout','forbid_visit']:
            del_black_user_ajax = DelBlackUserAjax(self.anchor_mobile)
            del_black_user_ajax.get({'room_id': self.room_id, 'anchor_id': self.anchor_id, 'user_id': self.user_id,'blacker_type': x})
        del_supervisor_ajax = DelSupervisorAjax(self.anchor_mobile)
    ...
    def test_high_admin_to_knight_forbid_speak(self):
        """
        测试高管对骑士禁言
        :return:
        """
    ...
    def test_high_admin_to_knight_forbid_shout(self):
        """
        测试高管对骑士禁止喊话
        :return:
        """
    ...
    def test_high_admin_to_knight_forbid_visit(self):
        """
        测试高管对骑士禁止访问
        :return:
        """
    ...
    def test_high_admin_to_baron_forbid_speak(self):
        """
        测试高管对男爵禁言
        :return:
        """
    ...
    def test_high_admin_to_baron_forbid_shout(self):
        """
        测试高管对男爵禁止喊话
        :return:
        """
    ...
    def test_high_admin_to_baron_forbid_visit(self):
        """
        测试高管对男爵禁止访问
        :return:
        """
    ...
    def test_high_admin_to_viscount_forbid_speak(self):
        """
        测试高管对子爵禁言
        :return:
        """
    ...
    def test_high_admin_to_viscount_forbid_shout(self):
        """
        测试高管无法对子爵禁止喊话
        :return:
        """
    ...
    def test_high_admin_to_viscount_forbid_visit(self):
        """
        测试高管对子爵禁止访问
        :return:
        """
    ...
    def test_high_admin_to_earl_forbid_speak(self):
        """
        测试高管对伯爵禁言
        :return:
        """
    ...
    def test_high_admin_to_earl_forbid_shout(self):
        """
        测试高管无法对伯爵禁止喊话
        :return:
        """
    ...
    def test_high_admin_to_earl_forbid_visit(self):
        """
        测试高管无法对伯爵禁止访问
        :return:
        """
    ...
    def test_high_admin_to_marquis_forbid_speak(self):
        """
        测试高管无法对侯爵禁言
        :return:
        """
    ...
    def test_high_admin_to_marquis_forbid_shout(self):
        """
        测试高管无法对侯爵禁止喊话
        :return:
        """
    ...
    def test_high_admin_to_marquis_forbid_visit(self):
        """
        测试高管无法对侯爵禁止访问
        :return:
        """
    ...
    def test_high_admin_to_duck_forbid_speak(self):
        """
        测试高管无法对公爵禁言
        :return:
        """
    ...
    def test_high_admin_to_duck_forbid_shout(self):
        """
        测试高管无法对公爵禁止喊话
        :return:
        """
    ...
    def test_high_admin_to_duck_forbid_visit(self):
        """
        测试高管无法对公爵禁止访问
        :return:
        """
    ...
    def test_high_admin_to_emperor_forbid_speak(self):
        """
        测试高管无法对帝王禁言
        :return:
        """
    ...
    def test_high_admin_to_emperor_forbid_shout(self):
        """
        测试高管无法对帝王禁止喊话
        :return:
        """
    ...
    def test_high_admin_to_emperor_forbid_visit(self):
        """
        测试高管无法对帝王禁止访问
        :return:
        """
    ...
    def tearDown(self, user_id=None, anchor_id=None):
        super(TestBlackUserAjaxHighAdmiToNoble,self).tearDown(user_id=self.user_id)
        for x in ['forbid_speak','forbid_shout','forbid_visit']:
            del_black_user_ajax = DelBlackUserAjax(self.anchor_mobile)
            del_black_user_ajax.get({'room_id': self.room_id, 'anchor_id': self.anchor_id, 'user_id': self.user_id,'blacker_type': x})
        del_supervisor_ajax = DelSupervisorAjax(self.anchor_mobile)
